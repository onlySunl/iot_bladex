package org.springblade.basic.database.properties;
...
import static org.springblade.basic.context.ContextConstants.TENANT_BASE_POOL_NAME_HEADER;
...
public class DatabaseProperties {
    ...
    /**
     * 扩展SQL参数（用于个性化 sql 参数）
     */
    private ExtendSqlParameters extendSqlParameters;
    /**
     * SCHEMA模式 租户库 前缀
     */
    ...
    @Data
    public static class ExtendSqlParameters {
        /**
         * TDengine 创建库选项（database_options 性能参数配置等）
         */
        private String tdengineCreateDatabaseOptions = "vgroups 10 buffer 10 precision 'ns'";
    }
    ...
    public static class DefaultId {
         ...
         * 可以改成你的项目开始开始的时间
         */
        private String epochStr = "2023-09-15";
        /**
