package org.springblade.basic.database.mybatis;//package org.springblade.basic.database.mybatis;
//
...
//        }
//
//        // 除了 superAdmin 账号，其他账号无权删除def库数据
//        // boolean isSuperAdmin = Long.valueOf(1L).equals(userId);
