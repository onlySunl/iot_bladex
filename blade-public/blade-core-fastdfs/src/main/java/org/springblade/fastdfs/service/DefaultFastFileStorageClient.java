...
import org.springblade.fastdfs.domain.fdfs.ThumbImageConfig;
...
import org.springblade.fastdfs.domain.upload.FastFile;
import org.springblade.fastdfs.domain.upload.FastImageFile;
...
public class DefaultFastFileStorageClient extends DefaultGenerateStorageClient implements FastFileStorageClient {
     ...
     * 支持的图片类型
     */
    private static final List<String> SUPPORT_IMAGE_LIST = FdfsClientConstants.SUPPORT_IMAGE_TYPE;
