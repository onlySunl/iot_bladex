package org.springblade.core.groovy.registry;
 ...
 * 引擎注册中心
 *
 * @author mqttsnet 2025/03/18 11:24
 */
public interface ScriptRegistry {
     ...
     * @author mqttsnet 2024/9/18 12:22 下午
     */
     ...
     * @return java.lang.Boolean 注册失败，则返回false，不抛出异常
     * @author mqttsnet 2024/10/1 3:08 下午
     */
     ...
     * @return {@link ScriptEntry}
     * @author mqttsnet 2024/10/1 2:47 下午
     */
     ...
     * @author mqttsnet 2024/9/18 1:23 下午
     */
     ...
     * @author mqttsnet 2024/10/1 2:53 下午
     */
     ...
     * </p>
     *
     * @author mqttsnet 2024/9/18 5:34 下午
     */
    void clear();
