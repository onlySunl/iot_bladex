package org.springblade.core.groovy.executor.impl;

import cn.hutool.core.util.StrUtil;
import com.google.common.base.Preconditions;
import org.springblade.core.groovy.constants.GroovyEngineConstants;
 ...
 * 默认引擎执行器
 *
 * @author mqttsnet 2025/03/18 12:39
 */
public class DefaultEngineExecutor implements EngineExecutor {
    ...
    public EngineExecutorResult execute(@NonNull String groovyMethodName,
        ...
        if (StrUtil.isBlank(groovyMethodName)) {
