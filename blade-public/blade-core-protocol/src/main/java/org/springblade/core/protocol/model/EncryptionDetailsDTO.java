...
public class EncryptionDetailsDTO implements Serializable {
    ...
    /**
     * The message ID is a unique identifier for the message. It is used to
     * identify the message and is typically generated by the sender.
     */
    private Long mId = Long.valueOf(SnowflakeIdUtil.nextId());
}
