package org.springblade.basic.base;
...
import org.springblade.basic.exception.code.BaseExceptionCode;
import org.springblade.basic.jackson.JsonUtil;

import java.util.HashMap;
import java.util.Map;

import static org.springblade.basic.context.ContextConstants.TRACE_ID_HEADER;
...
public class R<T> {
    ...
    public static final String LOCK_ACQUIRE_ERROR_MESSAGE = "操作过于频繁，请稍后再试";
    ...
    public static <E> R<E> fail() {
        return fail(FAIL_CODE, DEF_ERROR_MESSAGE);
    }
