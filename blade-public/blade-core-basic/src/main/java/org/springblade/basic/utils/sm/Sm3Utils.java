...
//        }
    ...
    public static String SM3Encode(String source, String charsetname)
        ...
        if (charsetname == null || "".equals(charsetname)) {
            resultString = byteArrayToHexString(Sm3Utils.hash(source.getBytes()));
        } else {
            resultString = byteArrayToHexString(Sm3Utils.hash(source.getBytes(charsetname)));
        }
        return resultString;
    }
    ...
    public static Map<String, String> makeToken(String appId, String appSecrect)
            throws IOException {
        ...
        token = Sm3Utils.SM3Encode(sb.toString(), "UTF-8");
    ...
    public static void main(String[] args)
        ...
        sm3HashValue = Sm3Utils.hash(source);
        System.out.println(Sm3Utils.SM3Encode(sm3HashValue.toString(), "utf-8"));
        String token = Sm3Utils.SM3Encode(
                "app_id5E6339211Ftimestamp2017-09-14 13:54:45 687trans_id20170914135445687536273PG65cP4C4977I0z3durISe1c24547409",
                "utf-8");
