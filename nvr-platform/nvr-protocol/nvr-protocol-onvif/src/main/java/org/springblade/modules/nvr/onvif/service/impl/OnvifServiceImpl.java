package org.springblade.modules.nvr.onvif.service.impl;
...
import org.springblade.modules.nvr.common.core.constant.Constants;
import org.springblade.modules.nvr.common.core.constant.SecurityConstants;
import org.springblade.modules.nvr.common.core.domain.R;
import org.springblade.modules.nvr.common.core.exception.ServiceException;
import org.springblade.modules.nvr.onvif.DiscoveryManager;
import org.springblade.modules.nvr.onvif.OnvifManager;
import org.springblade.modules.nvr.onvif.api.domain.WSOnvifDevice;
import org.springblade.modules.nvr.onvif.domain.FetchMainAndSubStreamUris;
import org.springblade.modules.nvr.onvif.domain.WSDiscoveryDevice;
import org.springblade.modules.nvr.onvif.enums.AuthTypeEnum;
import org.springblade.modules.nvr.onvif.listeners.DiscoveryListener;
...
import org.springblade.modules.nvr.onvif.models.*;
import org.springblade.modules.nvr.onvif.listeners.StorageInfoListener;
import org.springblade.modules.nvr.onvif.service.IOnvifService;
import org.springblade.modules.nvr.qs.api.RemoteQsDeviceService;
import org.springblade.modules.nvr.qs.api.RemoteQsDeviceSnapshotService;
import org.springblade.modules.nvr.qs.api.domain.QsDevice;
import org.springblade.modules.nvr.qs.api.domain.QsDeviceSnapshot;
...
public class OnvifServiceImpl implements IOnvifService {
     ...
     */
    @Override
    public org.springblade.modules.nvr.onvif.api.domain.OnvifDevice verifyOnvifDeviceLogin(WSOnvifDevice onvifDevice) {
        if (onvifDevice == null) {
            throw new IllegalArgumentException("设备信息不能为空");
        }
        
        org.springblade.modules.nvr.onvif.api.domain.OnvifDevice returnOnvifDevice = new org.springblade.modules.nvr.onvif.api.domain.OnvifDevice();
    ...
    private NetworkInfoResult getNetworkInfo(String deviceIp, String username, String password, String type) {
        ...
        org.springblade.modules.nvr.onvif.models.OnvifDevice onvifDevice = new org.springblade.modules.nvr.onvif.models.OnvifDevice(deviceIp, username, password);
        OnvifManager onvifManager = new OnvifManager();
        ...
        try {
            ...
            NetworkInfoListener listener = new NetworkInfoListener() {
                @Override
                public void onNetworkInfoReceived(org.springblade.modules.nvr.onvif.models.OnvifDevice device, NetworkInfo info) {
                ...
                @Override
                public void onError(org.springblade.modules.nvr.onvif.models.OnvifDevice device, int errorCode, String errorMessage) {
    ...
    private MediaInfoResult getMediaInfo(String deviceIp, String username, String password, String type) {
        ...
        try {
            ...
            MediaInfoListener listener = new MediaInfoListener() {
                @Override
                public void onMediaInfoReceived(org.springblade.modules.nvr.onvif.models.OnvifDevice device, MediaInfo info) {
