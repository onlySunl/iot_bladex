package org.springblade.modules.nvr.haikangisup.callBack;
...
import org.springblade.modules.nvr.domain.QsDeviceAlarm;
import org.springblade.modules.nvr.haikangisup.config.HaikangIsupConfig;
import org.springblade.modules.nvr.haikangisup.haikang.alarm.HCISUPAlarm;
import org.springblade.modules.nvr.haikangisup.utils.XmlParserUtils;
import org.springblade.modules.nvr.haikangisup.xml.EventNotificationAlert;
import org.springblade.modules.nvr.service.RemoteQsDeviceAlarmService;
...
public class EHomeMsgCallBack implements HCISUPAlarm.EHomeMsgCallBack {
    ...
    private void saveAlarmToDatabase(String deviceId, String deviceIp, EventNotificationAlert event,
        ...
        try {
            RemoteQsDeviceAlarmService remoteQsDeviceAlarmService = SpringUtil.getBean(RemoteQsDeviceAlarmService.class);
            RemoteQsDeviceService remoteQsDeviceService = SpringUtil.getBean(RemoteQsDeviceService.class);
