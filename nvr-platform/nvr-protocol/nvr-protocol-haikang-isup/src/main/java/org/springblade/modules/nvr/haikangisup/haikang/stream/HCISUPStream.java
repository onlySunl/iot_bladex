package org.springblade.modules.nvr.haikangisup.haikang.stream;

import com.sun.jna.Callback;
import com.sun.jna.Library;
import com.sun.jna.Pointer;
import org.springblade.modules.nvr.haikangisup.haikang.HIKSDKStructure;
...
public interface HCISUPStream extends Library {
    ...
    public class NET_EHOME_PREVIEW_DATA_CB_PARAM extends HIKSDKStructure {
        ...
        public byte byStreamFormat;       //码流封装格式：0-PS（预览仅支持PS格式）
        public byte[] byRes = new byte[127];      //保留，设为0
    }
