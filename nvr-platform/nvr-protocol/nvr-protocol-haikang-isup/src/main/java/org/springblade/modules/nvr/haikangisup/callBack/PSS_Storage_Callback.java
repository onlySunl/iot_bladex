...
import org.springblade.modules.nvr.domain.QsDeviceSnapshot;
import org.springblade.modules.nvr.haikangisup.haikang.ss.HCISUPSS;
...
public class PSS_Storage_Callback implements HCISUPSS.EHomeSSStorageCallBack {
    ...
    public static final String extractFilename(Long deviceId, int channelId) {
        ...
        return StringUtil.format("haikang_{}_{}_{}.jpg", deviceId, channelId, timeStr);
    }
