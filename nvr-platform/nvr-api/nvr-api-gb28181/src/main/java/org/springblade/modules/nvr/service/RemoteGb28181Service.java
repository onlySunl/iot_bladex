...
import org.springblade.modules.nvr.factory.RemoteGb28181FallbackFactory;
...
public interface RemoteGb28181Service {
    ...
    R<List<Gb28181Platform>> selectPlatformList(@RequestBody Gb28181Platform platform);
    ...
    R<Gb28181Platform> selectPlatformById(@PathVariable Long id);
    ...
    R<List<Gb28181PlatformChannel>> selectPlatformChannelList(@RequestBody Gb28181PlatformChannel channel);
    ...
    R<Boolean> updatePlatform(@RequestBody Gb28181Platform platform);
    ...
    R<Void> playbackStreamCmd(@RequestBody RtpServerParam rtpServer);
    ...
    R<Void> registerPlatform(@RequestBody Gb28181Platform platform);
    ...
    R<Void> unregisterPlatform(@RequestBody Gb28181Platform platform);
    ...
    R<Void> sendHeartbeat(@RequestBody Gb28181Platform platform);
    ...
    R<Void> sendDeviceInfo(@RequestBody Gb28181Platform platform);
    ...
    R<Void> sendCatalog(@RequestBody CatalogRequest catalogRequest);
    ...
    R<Void> startPlatformCascade(@PathVariable Long platformId);
    ...
    R<Void> stopPlatformCascade(@PathVariable Long platformId);
    ...
    R<Void> restartPlatformCascade(@PathVariable Long platformId);
    ...
    R<Void> pushCatalog(@PathVariable Long platformId);
    ...
    R<Object> queryDeviceConfig(@PathVariable String gbDeviceId, @RequestParam String configType);
    ...
    R<Object> updateDeviceConfig(@PathVariable String gbDeviceId, @RequestBody DeviceConfig deviceConfig);
    ...
    R<Object> queryHomePosition(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId);
    ...
    R<Object> updateHomePosition(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId, @RequestBody DeviceConfig deviceConfig);
    ...
    R<Object> queryCruiseTrackList(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId);
    ...
    R<Object> queryCruiseTrack(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId, @RequestParam Integer number);
    ...
    R<Object> queryPTZPosition(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId);
    ...
    R<Object> querySDCardStatus(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId);
    ...
    R<Object> alarmResetControl(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId, @RequestParam(required = false) String alarmMethod, @RequestParam(required = false) String alarmType);
    ...
    R<Object> iFrameControl(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId);
     ...
     */
    @PostMapping("/api/gb28181/homePosition/{gbDeviceId}")
    R<Object> homePositionControl(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId, @RequestBody DeviceConfig deviceConfig);
    ...
    R<Object> ptzPreciseControl(@PathVariable String gbDeviceId, @RequestParam(required = false) String channelId, @RequestBody JSONObject ptzPreciseCtrl);
    ...
    R<Object> timeCheckCmd(@PathVariable String gbDeviceId);
