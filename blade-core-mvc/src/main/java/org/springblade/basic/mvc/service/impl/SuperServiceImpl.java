package org.springblade.basic.mvc.service.impl;
...
import org.springblade.basic.mvc.manager.SuperManager;
...
public class SuperServiceImpl<M extends SuperManager<Entity>, Id extends Serializable, Entity extends SuperEntity<?>> implements SuperService<Id, Entity> {
    ...
    @Override
    @Transactional(readOnly = true)
    public Entity getByWrapper(Wrapper<Entity> queryWrapper) {
        return getSuperManager().getOne(queryWrapper);
    }
