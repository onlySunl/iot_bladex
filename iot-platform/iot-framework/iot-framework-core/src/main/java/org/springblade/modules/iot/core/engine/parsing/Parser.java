...
import static org.springblade.modules.iot.core.engine.parsing.TokenType.And;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Assignment;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Asterisk;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.AsteriskEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.BitAnd;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.BitAndEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.BitNot;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.BitOr;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.BitOrEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.BooleanLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.ByteLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Colon;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.ColonColon;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Comma;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.DecimalLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.DoubleLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Equal;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.EqualEqualEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.FloatLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.ForwardSlash;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.ForwardSlashEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Greater;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.GreaterEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Identifier;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.InstanceOf;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.IntegerLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.LShift;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.LShiftEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Lambda;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Language;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.LeftBracket;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.LeftCurly;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.LeftParantheses;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Less;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.LessEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.LongLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Minus;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.MinusEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.MinusMinus;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Not;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.NotEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.NotEqualEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.NullLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Or;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.PercentEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Percentage;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Period;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Plus;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.PlusEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.PlusPlus;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.QuestionMark;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.QuestionPeriod;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.RShift;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.RShift2Equal;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.RShiftEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.RegexpLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.RightBracket;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.RightCurly;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.RightParantheses;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Rshift2;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.ShortLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Spread;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.SqlAnd;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.SqlNotEqual;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.SqlOr;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.StringLiteral;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.Xor;
import static org.springblade.modules.iot.core.engine.parsing.TokenType.XorEqual;
...
import org.springblade.modules.iot.core.engine.parsing.ast.LanguageExpression;
...
import org.springblade.modules.iot.core.engine.parsing.ast.TernaryOperation;
import org.springblade.modules.iot.core.engine.parsing.ast.UnaryOperation;
import org.springblade.modules.iot.core.engine.parsing.ast.VariableSetter;
import org.springblade.modules.iot.core.engine.parsing.ast.binary.AssigmentOperation;
import org.springblade.modules.iot.core.engine.parsing.ast.linq.LinqExpression;
import org.springblade.modules.iot.core.engine.parsing.ast.linq.LinqField;
import org.springblade.modules.iot.core.engine.parsing.ast.linq.LinqJoin;
import org.springblade.modules.iot.core.engine.parsing.ast.linq.LinqOrder;
import org.springblade.modules.iot.core.engine.parsing.ast.linq.LinqSelect;
import org.springblade.modules.iot.core.engine.parsing.ast.linq.WholeLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.BigDecimalLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.BooleanLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.ByteLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.DoubleLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.FloatLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.IntegerLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.ListLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.LongLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.MapLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.NullLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.RegexpLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.ShortLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.literal.StringLiteral;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.Assert;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.AsyncCall;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.Break;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.ClassicForStatement;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.ClassConverter;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.Continue;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.Exit;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.ForStatement;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.FunctionCall;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.IfStatement;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.Import;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.LambdaFunction;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.MapOrArrayAccess;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.MemberAccess;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.MethodCall;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.NewStatement;
...
import org.springblade.modules.iot.core.engine.parsing.ast.statement.SwitchStatement;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.Throw;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.TryStatement;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.VariableAccess;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.VariableDefine;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.VariableDestructuringDefine;
import org.springblade.modules.iot.core.engine.parsing.ast.statement.WhileStatement;
