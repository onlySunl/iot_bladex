...
public interface BaseOrgService extends SuperCacheService<Long, BaseOrg> {
     ...
     * @return java.util.List<org.springblade.modules.iot.base.entity.user.BaseOrg>
     * @author mqttsnet
     ...
     *
     * @param employeeId 员工ID
     * @return java.util.List<org.springblade.modules.iot.model.entity.base.SysOrg>
     * @author mqttsnet
     ...
     * @return org.springblade.modules.iot.base.entity.user.BaseOrg
     * @author mqttsnet
