...
@Service
public class OtaUpgradeTasksServiceImpl extends BladeServiceImpl<OtaUpgradeTasksManager, Long, OtaUpgradeTasks> implements OtaUpgradeTasksService {
    ...
    private TopoOtaCommandResponseParam handleAndPersistOtaUpgradeRecord(TopoOtaCommandResponseParam topoOtaCommandResponseParam) {
        ...
        otaUpgradeRecordsService.getBladeService().saveOrUpdate(record);
