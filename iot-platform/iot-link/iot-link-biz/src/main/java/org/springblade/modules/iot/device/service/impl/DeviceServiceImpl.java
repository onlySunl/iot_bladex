...
public class DeviceServiceImpl extends BladeServiceImpl<DeviceManager, Long, Device> implements DeviceService {
    ...
    /**
     * 根据设备ID删除设备。删除成功后发布 {@link org.springblade.modules.iot.device.event.DeviceDeletedEvent},
