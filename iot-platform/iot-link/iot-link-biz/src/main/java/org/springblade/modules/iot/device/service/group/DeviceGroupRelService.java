 ...
 */
public interface DeviceGroupRelService extends BladeService<Long, DeviceGroupRel> {
    ...
    /**
     * 根据设备标识删除设备分组关系。
     * <p>设备删除时由 {@link org.springblade.modules.iot.device.event.DeviceDeletedEvent} 监听器调用，
