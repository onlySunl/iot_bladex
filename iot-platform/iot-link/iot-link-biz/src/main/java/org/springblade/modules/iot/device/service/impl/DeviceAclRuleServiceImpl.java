...
@Service
public class DeviceAclRuleServiceImpl extends BladeServiceImpl<DeviceAclRuleManager, Long, DeviceAclRule> implements DeviceAclRuleService {
    ...
    /**
     * BladeServiceImpl.removeByIds 没有 after 钩子,显式 override 发变更事件,
