...
import org.springblade.modules.iot.cacert.vo.query.license.CaCertLicensePageQuery;
...
public class CaCertLicenseController extends SuperController<CaCertLicenseService, Long, CaCertLicense
    ...
    /**
     * 吊销 CA 证书。
     * 将证书 state 改为 REVOKED + 发布 {@link org.springblade.modules.iot.cacert.event.CaRevokedEvent} 触发绑定设备 cache 失效。
     *
     * @param id               证书 ID
