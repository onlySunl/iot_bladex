package org.springblade.modules.iot.productservice.controller;
...
@Tag(name = "产品模型服务")
public class ProductServiceController extends BaseController<ProductServiceService, Long, ProductServices, ProductServiceSaveVO,
