package org.springblade.modules.iot.component.udp.dispatcher;

import org.springblade.modules.iot.component.udp.service.UdpComponent;
...
public class UdpPacketDispatcher {
    ...
    private static class UwbHandler implements PacketHandler {
        private static final byte[][] PREFIXES = Arrays.stream(
                        org.springblade.modules.iot.component.udp.enums.TagsForwardedTypeEnum.values()
