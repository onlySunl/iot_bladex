...
public class ChannelConfigController {
    ...
    public R<Long> createChannelConfig(@Valid @RequestBody ChannelConfig createReqVO) {
    ...
    public R<Boolean> updateChannelConfig(@Valid @RequestBody ChannelConfig updateReqVO) {
