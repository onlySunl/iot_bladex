package org.springblade.modules.iot.entity.device;
...
import org.springblade.modules.iot.device.enumeration.DeviceActionTypeEnum;
...
public class CommonDeviceEvent extends ApplicationEvent {
     ...
     * {@link org.springblade.modules.iot.basic.context.ContextUtil#setTenantId(Object)} 内部自适应 String/Long,
     * 无需调用方手动 valueOf.
     */
