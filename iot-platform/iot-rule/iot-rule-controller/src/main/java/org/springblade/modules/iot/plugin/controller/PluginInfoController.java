...
import org.springblade.modules.iot.vo.param.plugin.PluginActionRequestParamVO;
...
@Tag(name = "插件信息")
public class PluginInfoController extends BaseController<PluginInfoService, Long, PluginInfo, PluginInfoSaveVO, PluginInfoUpdateVO, PluginInfoPageQuery, PluginInfoResultVO> {
