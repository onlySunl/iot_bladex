...
@Tag(name = "插件实例心跳")
public class PluginInstanceHeartbeatController extends BaseController<PluginInstanceHeartbeatService, Long, PluginInstanceHeartbeat, PluginInstanceHeartbeatSaveVO,
