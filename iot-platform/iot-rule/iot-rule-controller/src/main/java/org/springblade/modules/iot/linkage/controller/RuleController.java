...
import org.springblade.modules.iot.vo.query.linkage.RulePageQuery;
import org.springblade.modules.iot.vo.result.linkage.RuleDetailsResultVO;
import org.springblade.modules.iot.vo.result.linkage.RuleResultVO;
...
@RequestMapping("/rule")
@Tag(name = "规则信息")
public class RuleController extends BaseController<RuleService, Long, Rule, RuleSaveVO,
