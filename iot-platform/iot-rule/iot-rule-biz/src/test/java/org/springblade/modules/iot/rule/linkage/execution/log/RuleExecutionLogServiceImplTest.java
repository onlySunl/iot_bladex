package org.springblade.modules.iot.rule.linkage.execution.log;
...
import org.springblade.modules.iot.service.linkage.impl.RuleExecutionLogServiceImpl;
...
class RuleExecutionLogServiceImplTest {
    ...
    void clearRuleExecutionLogsShouldRequireScopedQuery() {
        assertThrows(ServiceException.class, () -> service.clearRuleExecutionLogs(new RuleExecutionLogPageQuery()));
    }
