...
import org.springblade.modules.iot.common.condition.OperatorEnum;
import org.springblade.modules.iot.common.condition.BaseConditionDTO;
import org.springblade.modules.iot.common.condition.ConditionEvaluatorService;
...
import org.springblade.modules.iot.dto.linkage.condition.group.DevicePropertiesConditionDTO;
import org.springblade.modules.iot.dto.linkage.condition.group.DevicePropertiesConditionGroupDTO;
import org.springblade.modules.iot.dto.linkage.condition.group.DevicePropertiesLeftParamDTO;
import org.springblade.modules.iot.dto.linkage.condition.group.DevicePropertiesRightParamsDTO;
...
import org.springblade.modules.iot.enumeration.linkage.AntiShakeStatusEnum;
...
import org.springblade.modules.iot.service.execution.FieldValueWithType;
...
import org.springblade.modules.iot.service.execution.trigger.ActionCooldownService;
import org.springblade.modules.iot.service.execution.trigger.AntiShakeCounterService;
import org.springblade.modules.iot.service.execution.trigger.DeviceLatestSnapshotService;
...
public class DevicePropertiesPolicy implements RulePolicyStrategyService {
    ...
    private void validateContextAndPolicyDTO(PolicyContext context, RuleConditionPolicyDTO conditionPolicyDTO) {
        if (context == null || context.getRulePolicyDTO() == null) {
            ...
            throw new ServiceException("PolicyContext and RulePolicyDTO cannot be null.");
        }
