...
import org.springblade.modules.iot.common.model.Kv;
...
import org.springblade.modules.iot.enumeration.alarm.AlarmChannelStatusEnum;
...
@Service
public class RuleAlarmRecordServiceImpl extends BladeServiceImpl<RuleAlarmRecordManager, RuleAlarmRecord> implements RuleAlarmRecordService {
    ...
    public RuleAlarmRecordSaveVO saveAlarmRecord(RuleAlarmRecordSaveVO saveVO) {
        ...
        // Save alarm record
        baseMapper.save(ruleAlarmRecord);
    ...
    public RuleAlarmRecordUpdateVO updateAlarmRecord(RuleAlarmRecordUpdateVO updateVO) {
        ...
        // Update alarm record
        baseMapper.updateById(ruleAlarmRecord);
    ...
    public Boolean deleteAlarmRecord(Long id) {
        ...
        RuleAlarmRecord ruleAlarmRecord = baseMapper.getById(id);
        if (ruleAlarmRecord == null) {
            throw new ServiceException("The rule alarm record does not exist");
        }

        // TODO Validate if the alarm record is being used elsewhere or has dependencies
        // if (isRuleAlarmRecordInUse(id)) {
        //     throw new ServiceException("The rule alarm record is currently in use and cannot be deleted");
        // }
    ...
    public RuleAlarmRecordUpdateVO handleOrSolveAlarmRecord(RuleAlarmRecordHandleParamVO recordHandleParamVO) {
        ...
        RuleAlarmRecord existingRecord = baseMapper.getById(recordHandleParamVO.getId());
