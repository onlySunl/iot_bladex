 ...
 * @date 2026-04-28
 */
public interface SubscriptionSourceService extends BladeService<SubscriptionSource> {
     ...
     * @param id 订阅源主键 ID
     * @return true=删除成功
     * @throws org.springblade.modules.iot.basic.exception.ServiceException 订阅源处于启用状态时抛出
     */
