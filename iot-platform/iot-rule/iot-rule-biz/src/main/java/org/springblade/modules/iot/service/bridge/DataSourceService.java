 ...
 * @date 2026-04-28
 */
public interface DataSourceService extends BladeService<DataSource> {
     ...
     * 防绕过前端直接调 API。校验失败抛 ServiceException。</p>
     *
     * @param id     数据源主键 ID
    ...
    /**
     * 删除数据源（含关联引用检查）。
     * <p>检查以下 4 处引用，任一存在则抛 ServiceException 阻止删除：</p>
     * <ol>
     ...
     * @param id 数据源主键 ID
     * @return true=删除成功
     * @throws org.springblade.modules.iot.basic.exception.ServiceException 存在引用时抛出，错误信息含引用数量提示
     */
