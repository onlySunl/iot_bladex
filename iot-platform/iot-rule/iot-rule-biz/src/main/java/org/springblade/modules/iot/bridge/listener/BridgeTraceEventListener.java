package org.springblade.modules.iot.bridge.listener;

import org.springblade.core.secure.utils.AuthUtil;
import org.springblade.modules.iot.bridge.trace.BridgeTraceCompletedEvent;
...
public class BridgeTraceEventListener {
    ...
    public void onTraceCompleted(BridgeTraceCompletedEvent event) {
        ...
        try {
            // saveBatch + singletonList 绕开 BladeServiceImpl.save 的 BeanUtil.toBean 转换
