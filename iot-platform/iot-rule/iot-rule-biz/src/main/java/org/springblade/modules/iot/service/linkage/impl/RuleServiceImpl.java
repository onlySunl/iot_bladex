...
import org.springblade.core.cache.redis.CacheResult;
...
public class RuleServiceImpl extends BladeServiceImpl<RuleManager, Long, Rule> implements RuleService {
     ...
     */
    private boolean saveRuleToBladeService(Rule rule) {
        try {
