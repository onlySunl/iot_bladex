...
public class RuleServiceImpl extends BaseServiceImpl<RuleManager, Long, Rule> implements RuleService {
     ...
     */
    private boolean saveRuleToBaseService(Rule rule) {
        try {
