...
@Service
public class RuleGroovyScriptServiceImpl extends BaseServiceImpl<RuleGroovyScriptManager, Long, RuleGroovyScript> implements RuleGroovyScriptService {
    ...
    public Boolean flushGroovyScriptCache() {
        ...
        List<RuleGroovyScript> scripts = getBaseService().list(Wrappers.<RuleGroovyScript>lambdaQuery()
            .eq(RuleGroovyScript::getEnable, Boolean.TRUE));
