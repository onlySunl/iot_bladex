...
import org.springblade.common.groovy.entity.ScriptQuery;
import org.springblade.common.groovy.executor.EngineExecutor;
import org.springblade.common.groovy.loader.ScriptLoader;
...
@Service
public class RuleGroovyScriptServiceImpl extends BladeServiceImpl<RuleGroovyScriptManager, Long, RuleGroovyScript> implements RuleGroovyScriptService {
    ...
    public Boolean flushGroovyScriptCache() {
        ...
        List<RuleGroovyScript> scripts = getBladeService().list(Wrappers.<RuleGroovyScript>lambdaQuery()
            .eq(RuleGroovyScript::getEnable, Boolean.TRUE));
