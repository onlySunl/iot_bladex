 ...
 * @date 2026-04-28
 */
public interface DataBridgeService extends BladeService<DataBridge> {
     ...
     * @return {@link Map} 发送结果，键值参考 {@code org.springblade.modules.iot.basic.databridge.model.SendResult} 字段
     */
     ...
     * @param id 桥接规则主键 ID
     * @return true=删除成功
     * @throws org.springblade.modules.iot.basic.exception.ServiceException 规则处于启用状态时抛出
     */
