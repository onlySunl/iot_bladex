package org.springblade.model.entity.system;
...
import org.springblade.common.mybatis.typehandler.EncryptTypeHandler;
import org.springblade.model.constant.EchoApi;
import org.springblade.model.constant.EchoDictType;
import org.springblade.model.entity.base.SysEmployee;
import org.springblade.model.entity.base.SysOrg;
import org.springblade.model.entity.base.SysPosition;
...
public class SysUser extends CustomBaseEntity implements Serializable, EchoVO {
    @Serial
    ...
    @TableField(value = "nick_name", condition = Condition.LIKE)
    ...
    @TableField(value = "wx_open_id", condition = Condition.LIKE)
    private String wxOpenId;
    /**
     * 钉钉OpenId
     */
    @Schema(description = "钉钉OpenId")
    @TableField(value = "dd_open_id", condition = Condition.LIKE)
    ...
    @TableField(value = "nation", condition = Condition.LIKE)
    ...
    @TableField(value = "education", condition = Condition.LIKE)
    ...
    @TableField(value = "work_describe", condition = Condition.LIKE)
