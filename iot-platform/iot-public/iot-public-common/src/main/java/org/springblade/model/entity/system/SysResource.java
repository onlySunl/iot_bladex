...
public class SysResource extends TreeEntity<SysResource, Long> {
     ...
     */
    @TableField(value = "resource_type", condition = Condition.LIKE)
    private String resourceType;

    /**
     * 描述;resource_type=接口时表示接口说明
     */
    @TableField(value = "describe_", condition = Condition.LIKE)
     ...
     */
    @TableField(value = "path", condition = Condition.LIKE)
    private String path;

    /**
     * 打开方式 [01-组件 02-内链 03-外链]
     */
    @TableField(value = "open_with", condition = Condition.LIKE)
     ...
     */
    @TableField(value = "component", condition = Condition.LIKE)
    private String component;

    /**
     * 重定向;用于resource_type=菜单和视图
     */
    @TableField(value = "redirect", condition = Condition.LIKE)
    private String redirect;

    /**
     * 图标
     */
    @TableField(value = "icon", condition = Condition.LIKE)
    private String icon;
     ...
     * 分组
     */
    @TableField(value = "sub_group", condition = Condition.LIKE)
     ...
     */
    @TableField(value = "data_scope", condition = Condition.LIKE)
    private String dataScope;
    /**
     * 实现类;自定义实现类全类名
     */
    @TableField(value = "custom_class", condition = Condition.LIKE)
     ...
     * 元数据;菜单视图的元数据
     */
    @TableField(value = "meta_json", condition = Condition.LIKE)
