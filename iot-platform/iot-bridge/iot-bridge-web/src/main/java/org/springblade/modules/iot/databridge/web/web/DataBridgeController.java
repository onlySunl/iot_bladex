...
public class DataBridgeController extends BladeController {
    ...
    public R<Void> testResource(@PathVariable Long id) {
        ...
        if (connectionTestResult.isSuccess()) {
            return R.success(connectionTestResult.getMessage());
        }
    ...
    public R<List<ResourceConnection>> listResources() {
        try {
            ...
            List<ResourceConnection> connections = resourceConnectionService.getAllConnections();

            return R.data(connections);
        } catch (Exception e) {
            log.error("获取资源连接列表失败", e);
    ...
    public R<Void> updateResource(
        ...
        try {
            ...
            return R.success("更新资源连接成功");
        } catch (Exception e) {
            log.error("更新资源连接失败", e);
    ...
    public R<Void> deleteResource(@PathVariable Long id) {
        try {
            ...
            return R.success("删除资源连接成功");
        } catch (Exception e) {
            log.error("删除资源连接失败", e);
    ...
    public R<Void> updateConfig(
        ...
        try {
            ...
            return R.success("更新桥接配置成功");
        } catch (Exception e) {
            log.error("更新桥接配置失败", e);
    ...
    public R<Void> deleteConfig(@PathVariable Long id) {
        try {
            ...
            return R.success("删除桥接配置成功");
        } catch (Exception e) {
            log.error("删除桥接配置失败", e);
    ...
    public R<Boolean> validateConfig(@PathVariable Long id) {
        try {
            ...
            log.error("验证桥接配置失败", e);
            return R.fail("验证桥接配置失败: " + e.getMessage());
        }
    }
    ...
    public R<List<DataBridgeConfig>> getConfigsByScope(@PathVariable String scope) {
        try {
            ...
            List<DataBridgeConfig> configs = null;
            return R.data(configs);
        } catch (Exception e) {
            log.error("根据方向获取配置列表失败", e);
            return R.fail("根据方向获取配置列表失败: " + e.getMessage());
        }
    }
    ...
    public R<List<ResourceConnection>> getResourcesByDirection(
        ...
        try {
            ...
            List<ResourceConnection> connections = resourceConnectionService.getConnectionsByDirection(dir);
            return R.data(connections);
        } catch (Exception e) {
            log.error("根据方向获取资源连接列表失败", e);
            return R.fail("根据方向获取资源连接列表失败: " + e.getMessage());
        }
    }
    ...
    public R<List<String>> getBidirectionalResourceTypes() {
        try {
            ...
            log.error("获取双向资源类型失败", e);
            return R.fail("获取双向资源类型失败: " + e.getMessage());
        }
    }
    ...
    public R<List<String>> getOutputOnlyResourceTypes() {
        try {
            ...
            log.error("获取仅输出资源类型失败", e);
            return R.fail("获取仅输出资源类型失败: " + e.getMessage());
        }
    }
    ...
    public R<Map<String, Object>> getAllResourceTypes(
        ...
        try {
            ...
            // 获取所有插件信息
            Map<String, PluginInfo> pluginInfos = dataBridgeManager.getPluginInfos();
            log.info("获取到 {} 个插件信息", pluginInfos.size());
            ...
            return R.fail("获取资源类型失败: " + e.getMessage());
        }
    }
    ...
    private boolean isValidResourceType(String resourceType) {
        try {
            ...
            log.warn("资源类型 {} 不在枚举中，跳过", resourceType);
            return false;
        }
    }
    ...
    public R<Boolean> validateInputConfig(@PathVariable Long id) {
        try {
            ...
            log.error("验证输入配置失败", e);
            return R.fail("验证输入配置失败: " + e.getMessage());
        }
    }
    ...
    public R<String> getInputConfigTemplate(@PathVariable String bridgeType) {
        try {
            ...
            log.error("获取输入配置模板失败", e);
            return R.fail("获取输入配置模板失败: " + e.getMessage());
        }
    }
}
