package org.springblade.modules.iot.broker.ws.endpoint;
...
import org.springblade.modules.iot.entity.protocol.base.ClientConnectedEvent;
import org.springblade.modules.iot.entity.protocol.base.ClientDisconnectEvent;
import org.springblade.modules.iot.entity.protocol.base.DistErrorEvent;
import org.springblade.modules.iot.entity.protocol.base.DistedEvent;
import org.springblade.modules.iot.entity.protocol.base.PingReqEvent;
...
public class WebSocketDeviceOpenAccessProtocolEndpoint {
    ...
    private void initSpringBeans() {
        if (kafkaProducerService == null) {
            kafkaProducerService = SpringUtil.getBean(KafkaProducerService.class);
            wsDeviceSessionRegistry = SpringUtil.getBean(WsDeviceSessionRegistry.class);
            deviceOpenAnyTenantApi = SpringUtil.getBean(DeviceOpenAnyTenantFacade.class);
            wsHeartbeatTracker = SpringUtil.getBean(WsHeartbeatTracker.class);
        }
    }
    ...
    public void onClose(Session session,
        ...
        try {
            wsDeviceSessionRegistry.remove(tenantId, clientId);
        } catch (Exception e) {
    ...
    private void touchHeartbeat(WsDeviceSessionInfo ctx) {
        try {
            wsHeartbeatTracker.update(ctx.getTenantId(), ctx.getClientId());
        } catch (Exception e) {
    ...
    private void publishUplink(Session session, WsDeviceSessionInfo ctx, String text) {
        ...
        try {
            ...
            DistedEvent event = DistedEvent.builder()
                ...
                .success("success")
                .messageId(Long.valueOf(IdUtil.getSnowflake().nextId()))
                .topic(topic)
