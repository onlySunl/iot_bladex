package org.springblade.modules.iot.entity.ws.protocol;
 ...
 * 报文后 Jackson 反序列化为本类,再由 Adapter 转成 {@link org.springblade.modules.iot.entity.protocol.DeviceProtocolEvent}。
 *
 * <h3>子协议规约（设备 → 平台）</h3>
 * <pre>
 * {@code
