package org.springblade.common.iot.lock.video;
...
import org.springblade.common.iot.lock.LockKeyTable;

/**
 * Video 模块分布式锁 Key 构建器
 * <p>
 * 参照 {@link org.springblade.common.iot.lock.link.LinkLockKeyBuilder} 实现。
