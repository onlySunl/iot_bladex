package org.springblade.common.iot.utils;
...
public class FreeMarkerUtil {
    ...
    private static void generateSharedVariable() {
        try {
            ...
            TemplateHashModel strPool = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.StrPool");
            FREEMARKER_CFG.setSharedVariable("StrPool", strPool);
            TemplateHashModel dateUtils = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.DateUtils");
            FREEMARKER_CFG.setSharedVariable("DateUtils", dateUtils);
            TemplateHashModel argumentAssert = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.ArgumentAssert");
            FREEMARKER_CFG.setSharedVariable("ArgumentAssert", argumentAssert);
            TemplateHashModel beanPlusUtil = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.BeanPlusUtil");
            FREEMARKER_CFG.setSharedVariable("BeanPlusUtil", beanPlusUtil);
            TemplateHashModel collHelper = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.CollHelper");
            FREEMARKER_CFG.setSharedVariable("CollHelper", collHelper);
            TemplateHashModel springUtils = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.SpringUtils");
            FREEMARKER_CFG.setSharedVariable("SpringUtils", springUtils);
            TemplateHashModel strHelper = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.StrHelper");
            FREEMARKER_CFG.setSharedVariable("StrHelper", strHelper);
            TemplateHashModel treeUtil = (TemplateHashModel) staticModels.get("org.springblade.basic.utils.TreeUtil");
