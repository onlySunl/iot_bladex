...
public interface ConsumerGroupConstant {
     ...
     */
    String IOT_MQ_NAMESPACE = "iot";

    /**
     * Consumer Group 使用的大写命名空间，由小写命名空间派生生成。
     */
    String IOT_MQ_NAMESPACE_UPPER = "THINGLINKS";

    /**
     * Kafka 与 RocketMQ 消费组共用的前缀，由大写命名空间派生并与业务用途后缀组合。
     */
    String IOT_CONSUMER_GROUP_PREFIX = "CID_" + IOT_MQ_NAMESPACE_UPPER + "_";

    /**
     * 默认消费者组常量，值指向小写命名空间。
     */
    String IOT_GROUP = IOT_MQ_NAMESPACE;
}
