package org.springblade.common.iot.mq;
...
public interface KafkaConsumerTopicConstant {
    ...
    interface Mqs {
        ...
        interface MqsMqtt {
             ...
             */
            String IOT_MQTT_CLIENT_UNAUTHORIZED_TOPIC = "mqtt.client.unauthorized";

            /**
             * MQTT session 创建审计 (BifroMQ MQTT_SESSION_START) ── audit 用,mqs 侧仅 log 消费.
             */
            String IOT_MQTT_SESSION_START_TOPIC = "mqtt.session.start";

            /**
             * MQTT session 销毁审计 (BifroMQ MQTT_SESSION_STOP) ── audit 用,mqs 侧仅 log 消费.
             */
            String IOT_MQTT_SESSION_STOP_TOPIC = "mqtt.session.stop";
        ...
        interface MqsWebSocket {
             ...
             * Device online
             */
            String IOT_WEBSOCKET_CLIENT_CONNECTED_TOPIC = "websocket.client.connected.topic";

            /**
             * Client device offline
             */
            String IOT_WEBSOCKET_CLIENT_DISCONNECTED_TOPIC = "websocket.client.disconnect.topic";

            /**
             * Server device offline
             */
            String IOT_WEBSOCKET_SERVER_DISCONNECTED_TOPIC = "websocket.server.disconnect.topic";

            /**
             * Device kicked off
             */
            String IOT_WEBSOCKET_DEVICE_KICKED_TOPIC = "websocket.device.kicked.topic";

            /**
             * Message distribution error
             */
            String IOT_WEBSOCKET_DISTRIBUTION_ERROR_TOPIC = "websocket.distribution.error.topic";

            /**
             * Message distribution completed
             */
            String IOT_WEBSOCKET_DISTRIBUTION_COMPLETED_TOPIC = "websocket.distribution.completed.topic";

            /**
             * PING request
             */
            String IOT_WEBSOCKET_PING_REQ_TOPIC = "websocket.ping.req.topic";
        }
        ...
        interface MqsTcp {
             ...
             * Device online
             */
            String IOT_TCP_CLIENT_CONNECTED_TOPIC = "tcp.client.connected.topic";

            /**
             * Client device offline
             */
            String IOT_TCP_CLIENT_DISCONNECTED_TOPIC = "tcp.client.disconnect.topic";

            /**
             * Server device offline
             */
            String IOT_TCP_SERVER_DISCONNECTED_TOPIC = "tcp.server.disconnect.topic";

            /**
             * Device kicked off
             */
            String IOT_TCP_DEVICE_KICKED_TOPIC = "tcp.device.kicked.topic";

            /**
             * Message subscription acknowledgment
             */
            String IOT_TCP_SUBSCRIPTION_ACKED_TOPIC = "tcp.subscription.acked.topic";

            /**
             * Unsubscription acknowledgment
             */
            String IOT_TCP_UNSUBSCRIPTION_ACKED_TOPIC = "tcp.unsubscription.acked.topic";

            /**
             * Message distribution error
             */
            String IOT_TCP_DISTRIBUTION_ERROR_TOPIC = "tcp.distribution.error.topic";

            /**
             * Message distribution completed
             */
            String IOT_TCP_DISTRIBUTION_COMPLETED_TOPIC = "tcp.distribution.completed.topic";

            /**
             * PING request
             */
            String IOT_TCP_PING_REQ_TOPIC = "tcp.ping.req.topic";
        }
    }
}
