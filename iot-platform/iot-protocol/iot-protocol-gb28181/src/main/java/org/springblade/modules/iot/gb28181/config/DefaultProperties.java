...
//        Logger log = LoggerFactory.getLogger(AlarmNotifyMessageHandler.class);
        if (sipLog) {
            properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "org.springblade.modules.iot.gb28181.config.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "org.springblade.modules.iot.gb28181.config.ServerLoggerImpl");
