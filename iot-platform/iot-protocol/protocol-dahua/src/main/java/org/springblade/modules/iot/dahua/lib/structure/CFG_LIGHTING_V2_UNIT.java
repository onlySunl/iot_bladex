...
public class CFG_LIGHTING_V2_UNIT extends NetSDKLib.SdkStructure {
	/**
	 * 灯光类型 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_CFG_LC_LIGHT_TYPE}
	 */
    public int              emLightType;
	/**
	 * 灯光模式 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_CFG_LC_MODE}
	 */
    public int              emMode;
	/**
	 * 灯光补偿
