...
public class CFG_ALARMIN_INFO extends SdkStructure {
    ...
    public int              nPole;
    /**
     * 传感器感应方式 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_SENSE_METHOD}
     */
    public int              emSense;
    /**
     * / 报警使能控制方式 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_CTRL_ENABLE}
     */
    public int              emCtrl;
    /**
    ...
    /**
     * / 防区类型, 具体支持的类型通过查询能力获得 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_CFG_DEFENCEAREATYPE}
     */
