...
*/
public class MEDIAFILE_IVS_EVENT_INFO extends SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    ...
    /**
     * 事件动作,参见枚举定义 {@link NET_CROSSREGION_ACTION_INFO}
    */
    public int              emAction;
    /**
    ...
    */
    ...
    /**
     * 规则触发的对象类型,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_MEDIAFILE_IVS_OBJECT}
    */
    ...
    */
    ...
    /**
     * 物体型心(不是包围盒中心), 0-8191相对坐标, 相对于小图,参见结构体定义 {@link NET_POINT}
    */
