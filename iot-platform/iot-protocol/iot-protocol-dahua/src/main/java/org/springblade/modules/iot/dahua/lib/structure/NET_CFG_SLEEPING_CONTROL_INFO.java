...
*/
public class NET_CFG_SLEEPING_CONTROL_INFO extends SdkStructure
{
    /**
     * 结构体大小, 必须赋值
    */
    ...
    */
    public int              bEnable;
    /**
     * 低功耗模式,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_SLEEPING_CONTRONL_MODE}
    */
    public int              emMode;
    /**
     * 云台联动动作打断归位时间 单位秒
