...
import org.springblade.modules.iot.dahua.lib.structure.CFG_DETAIL_DRIVEASSISTANT_INFO;
import org.springblade.modules.iot.dahua.lib.structure.CFG_DETECT_REGIONS_INFO;
import org.springblade.modules.iot.dahua.lib.structure.CFG_PARKING_STATISTICS_INFO;
...
public static class NET_PD_VIDEOANALYSE extends SdkStructure {
    ...
    public NET_COMMON_STRING_64[] SupportRules = (NET_COMMON_STRING_64[]) new NET_COMMON_STRING_64().toArray(NET_VIDEOANALYSE_RULES);
    ;       // 支持的规则
}
