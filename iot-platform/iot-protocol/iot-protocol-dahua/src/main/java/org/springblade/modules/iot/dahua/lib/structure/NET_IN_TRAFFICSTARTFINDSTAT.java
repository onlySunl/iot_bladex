 ...
 */
public class NET_IN_TRAFFICSTARTFINDSTAT extends SdkStructure {
	/**
	 * 此结构体大小
	 */
    public int              dwSize;
	...
	/**
	 * 查询要求返回的统计信息粒度 默认按小时
	 * {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_GRANULARITY_STARTFIND_TYPE}
	 */
    public int              emGranularity;
	/**
	 * 统计方向查询条件 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_STARTFIND_DIRECTION}
	 */
