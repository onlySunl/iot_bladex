 ...
 * 防补光过曝
*/
public class NET_ANTIFILLLIGHTOVEREXPOSURE extends SdkStructure
{
    /**
     * 支持防补光过曝的目标类型,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_LC_TARGETMODE}
    */
