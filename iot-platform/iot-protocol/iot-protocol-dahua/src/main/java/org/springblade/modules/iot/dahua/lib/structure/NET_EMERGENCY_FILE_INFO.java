 ...
 * 文件信息
*/
public class NET_EMERGENCY_FILE_INFO extends SdkStructure
{
    /**
     * 原始文件创建时文件的唯一标示
    */
    ...
    */
    ...
    /**
     * 文件的真实类型,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_MOBILE_ENFORCE_FORMAT}
    */
    public int              emFormat;
    /**
     * 文件后缀类型,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_MOBILE_ENFORCE_FILE_TYPE}
    */
