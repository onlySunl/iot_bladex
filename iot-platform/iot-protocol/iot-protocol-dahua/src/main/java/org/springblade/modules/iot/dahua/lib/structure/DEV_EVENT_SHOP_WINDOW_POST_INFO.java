 ...
 * @version 1.0
 * @description 事件类型
 * {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_EVENT_IVS_TYPE#EVENT_IVS_SHOP_WINDOW_POST}(橱窗张贴事件)对应的数据块描述信息
 * @date 2020/11/16
 */
public class DEV_EVENT_SHOP_WINDOW_POST_INFO extends SdkStructure {
    /**
     * 通道号
     */
