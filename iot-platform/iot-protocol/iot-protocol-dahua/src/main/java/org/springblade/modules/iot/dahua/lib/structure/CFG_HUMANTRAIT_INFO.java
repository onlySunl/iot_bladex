...
*/
public class CFG_HUMANTRAIT_INFO extends SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 支持的目标检测类型列表,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_VIDEO_ANALYSE_HUMANFACE_TYPE}
    */
    ...
    */
    ...
    /**
     * 规则特定的尺寸过滤器，提高判断精度,参见结构体定义 {@link CFG_SIZEFILTER_INFO}
    */
    ...
    */
    ...
    /**
     * 需检测的目标属性,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_FACEFEATURE_TYPE}
    */
