 ...
 */
public class MEDIAFILE_SMART_KITCHEN_CLOTHES_DETECTION_INFO extends SdkStructure {
    public  int             dwSize;                               // 结构体大小
    public 	int             nChannelID;                           // 通道号从0开始,-1表示查询所有通道
    public  NET_TIME stuStartTime;                      // 开始时间
    public 	NET_TIME stuEndTime;                        // 结束时间
    public  int             emHasMask;                            /** 厨师口罩状态 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_STATE} */
    public 	int             emHasChefHat;                         /** 厨师帽状态 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_STATE} */
    public 	int             emHasChefClothes;                     /** 厨师服状态 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_STATE} */
    public  int             emChefClothesColor;                   /**厨师服颜色 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_COLOUR} */
