 ...
 * 云台补光灯联动项
*/
public class NET_CFG_LIGHTING_LINK_INFO extends SdkStructure
{
    /**
     * 使能
    */
    public int              bEnable;
    /**
     * 闪烁灯光类型,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.NET_EM_FILCKERLIGHT_TYPE}
    */
    public int              emFilckerLightType;
    /**
     * 灯光联动方式,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.NET_EM_LIGHTLINK_TYPE}
    */
