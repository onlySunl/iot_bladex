 ...
 */
public class NET_IN_DOFIND_FACERECONGNITION_EX extends SdkStructure {
    public int              dwSize;
    /**
     * 查询句柄
     */
    ...
    public int              nCount;
    /**
     * 指定查询结果返回图片的格式 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_NEEDED_PIC_RETURN_TYPE}
     */
