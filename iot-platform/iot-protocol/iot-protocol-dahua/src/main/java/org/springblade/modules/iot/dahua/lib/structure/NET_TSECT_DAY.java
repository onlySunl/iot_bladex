...
import static org.springblade.modules.iot.dahua.lib.NET_TSCHE_SEC_NUM;
...
public class NET_TSECT_DAY extends SdkStructure {
     ...
     * 时间段结构
     */
    public NET_TSECT[] stuSchedule = new NET_TSECT[NET_TSCHE_SEC_NUM];

    public NET_TSECT_DAY() {
        for (int i = 0; i < stuSchedule.length; i++) {
            stuSchedule[i] = new NET_TSECT();
        }
    }
}
