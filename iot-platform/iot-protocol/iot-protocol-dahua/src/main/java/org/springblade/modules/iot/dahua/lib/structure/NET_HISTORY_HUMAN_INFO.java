...
public class NET_HISTORY_HUMAN_INFO extends SdkStructure
{
    ...
    */
    public int              emCap;
    /**
     * 是否有背包,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_HAS_BACK_BAG}
    */
    public int              emHasBackBag;
    /**
     * 是否带手提包,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_HAS_CARRIER_BAG}
    */
    public int              emHasCarrierBag;
    /**
     * 是否有肩包,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_HAS_SHOULDER_BAG}
    */
    public int              emHasShoulderBag;
    /**
     * 是否有斜跨包,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_HAS_MESSENGER_BAG}
    */
