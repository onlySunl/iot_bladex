 ...
 * 对应枚举类型{@link org.springblade.modules.iot.dahua.lib.enumeration.NET_EM_CFG_OPERATE_TYPE#NET_EM_CFG_ACCESSCTL_SPECIALDAYS_SCHEDULE}
 * @date 2020/10/19
 */
public class NET_CFG_ACCESSCTL_SPECIALDAYS_SCHEDULE_INFO extends SdkStructure {
    public int              dwSize;
    /**
     * 假日计划名称
     */
    ...
    public int              bSchdule;
    /**
     * {@link org.springblade.modules.iot.dahua.lib.enumeration.NET_EM_CFG_OPERATE_TYPE#NET_EM_CFG_ACCESSCTL_SPECIALDAY_GROUP} 配置的下标
     */
    public int              nGroupNo;
    /**
     * 一天的时间段个数
