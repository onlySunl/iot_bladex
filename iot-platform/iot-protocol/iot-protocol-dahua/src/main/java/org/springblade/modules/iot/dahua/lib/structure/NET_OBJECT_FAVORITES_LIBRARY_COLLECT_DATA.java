 ...
 * 收藏的目标事件数据
*/
public class NET_OBJECT_FAVORITES_LIBRARY_COLLECT_DATA extends SdkStructure
{
    /**
     * 候选人来自哪个数据库,参见枚举定义 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_PEOPLE_GROUP_TYPE}
    */
    public int              emRange;
    /**
     * 通道号
