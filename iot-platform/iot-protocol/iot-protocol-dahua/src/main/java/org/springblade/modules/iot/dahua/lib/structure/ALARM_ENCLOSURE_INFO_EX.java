 ...
 */
public class ALARM_ENCLOSURE_INFO_EX extends SdkStructure {
	/**
	 * 通道号
	 */
	...
	/**
	 * 围栏报警类型 {@link org.springblade.modules.iot.dahua.lib.enumeration.EM_ENCLOSURE_TYPE_EX}
	 */
    public int              emType;
	/**
	 * 返回详细类型个数
	...
	/**
	 * 详细类型,参考枚举{@link org.springblade.modules.iot.dahua.lib.enumeration.EM_ENCLOSURE_ALARM_TYPE_EX}
	 */
