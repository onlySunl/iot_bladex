...
import org.springblade.modules.iot.common.utils.ObjectUtils;
import org.springblade.modules.iot.mybatis.core.enums.DbTypeEnum;
...
public class JdbcUtil {
    ...
    public static DbType getDbType() {
        ...
        try (Connection conn = dataSource.getConnection()) {
            return DbTypeEnum.find(conn.getMetaData().getDatabaseProductName()).getDbType();
